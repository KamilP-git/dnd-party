...
export default function CampaignPlayPage() {
  ...
  useEffect(() => {
    ...
    const foundCharacter = characters.find(
      (savedCharacter) =>
        savedCharacter.id === characterId &&
        getCharacterCampaignIds(savedCharacter).includes(campaignId),
    );
  ...
  function saveCharacter(updatedCharacter: Character) {
    ...
    const currentCampaignIds = getCharacterCampaignIds(updatedCharacter);

    const characterWithCampaigns = {
      ...updatedCharacter,
    ...
    setCharacter(characterWithCampaigns);
  }
  ...
  function addAttackSpell(event: FormEvent<HTMLFormElement>) {
    ...
    const imageUrl = String(formData.get("attackSpellImageUrl") || "").trim();
  ...
  function addClassFeature(event: FormEvent<HTMLFormElement>) {
    ...
    const imageUrl = String(formData.get("classFeatureImageUrl") || "").trim();
  ...
  function removeDiceRoll(rollId: string) {
    const updatedRolls = diceRolls.filter((roll) => roll.id !== rollId);

    saveRolls(updatedRolls);
  }

  function clearDiceRollHistory() {
  ...
  function handleDicePoolRoll(event: FormEvent<HTMLFormElement>) {
    ...
    const newRoll: DiceRoll = {
      ...
      formula: getDicePoolFormula(dicePool, diceModifier),
      reason,
      rolls,
              ...
              <div className="mt-6 grid gap-6">
                <section className="grid gap-6 rounded-xl border border-neutral-700 bg-neutral-800 p-5 xl:grid-cols-[minmax(0,1fr)_clamp(260px,28vw,420px)]">
                  ...
                  <section className="rounded-xl border border-neutral-700 bg-neutral-900 p-5">
                    ...
                    <div className="mt-4 overflow-hidden rounded-xl border border-neutral-700 bg-neutral-950">
                    ...
                    <div className="mt-4">
                      <p className="text-sm font-semibold text-neutral-400">
                        Ścieżka / link do grafiki
                      </p>

                      <EditableText
                        value={character.portraitUrl || ""}
                        placeholder="/images/portraits/postac.png"
                        onSave={(value) =>
                          updateCharacterTextField("portraitUrl", value)
                        }
                        className="mt-1 block w-full rounded-lg border border-neutral-700 bg-neutral-950 p-3 text-left text-sm"
                        inputClassName="mt-1 w-full rounded-lg border border-red-700 bg-neutral-950 p-3 text-sm"
                      />
                    </div>
                  </section>
                </section>
              ...
              <div className="mt-6 grid gap-5">
                <section className="grid h-[650px] grid-rows-[auto_auto_minmax(0,1fr)] rounded-xl border border-neutral-700 bg-neutral-800 p-4">
                  ...
                  <form
                    ...
                    className="mt-4 grid gap-2 rounded-xl border border-neutral-700 bg-neutral-900 p-3 xl:grid-cols-[1fr_1fr_130px_130px_auto]"
                  >
                    <input
                    ...
                    <input
                      name="attackSpellImageUrl"
                      placeholder="/images/actions/bow.png"
                      className="rounded-lg border border-neutral-700 bg-neutral-950 p-2"
                    />
                    ...
                    <textarea
                      ...
                      className="min-h-20 rounded-lg border border-neutral-700 bg-neutral-950 p-2 xl:col-span-5"
                    />
                  </form>
                          ...
                          >
                            ...
                            <div className="grid gap-3 lg:grid-cols-[190px_minmax(0,1fr)]">
                              <div>
                                ...
                                <EditableText
                                  value={item.imageUrl || ""}
                                  placeholder="/images/actions/nazwa.png"
                                  onSave={(value) =>
                                  ...
                                  className="mt-2 block w-full rounded-lg border border-neutral-700 bg-neutral-900 p-2 text-left text-xs text-neutral-400"
                                  inputClassName="mt-2 w-full rounded-lg border border-red-700 bg-neutral-900 p-2 text-xs"
                                />
                              </div>
                ...
                <section className="grid h-[540px] grid-rows-[auto_auto_minmax(0,1fr)] rounded-xl border border-neutral-700 bg-neutral-800 p-4">
                  ...
                  <form
                    ...
                    className="mt-4 grid gap-2 rounded-xl border border-neutral-700 bg-neutral-900 p-3 xl:grid-cols-[1fr_1fr_auto]"
                  >
                    <input
                    ...
                    <input
                      name="classFeatureImageUrl"
                      placeholder="/images/features/chef.png"
                      className="rounded-lg border border-neutral-700 bg-neutral-950 p-2"
                    />
                          ...
                          >
                            ...
                            <div className="grid gap-4 lg:grid-cols-[170px_minmax(0,1fr)]">
                              <div>
                                ...
                                <EditableText
                                  value={item.imageUrl || ""}
                                  placeholder="/images/features/nazwa.png"
                                  onSave={(value) =>
            ...
            {characterTab === "inventory" ? (
              <section className="mt-6 grid h-[640px] grid-rows-[auto_auto_minmax(0,1fr)] rounded-xl border border-neutral-700 bg-neutral-800 p-4">
                ...
                <form
                  ...
                  className="mt-4 grid gap-2 rounded-xl border border-neutral-700 bg-neutral-900 p-3 xl:grid-cols-[1fr_1fr_110px_auto]"
                >
                  <input
                    name="itemName"
                    required
                  ...
                  <textarea
                    ...
                    className="h-16 max-h-16 min-h-16 resize-none overflow-y-auto rounded-lg border border-neutral-700 bg-neutral-950 p-2 xl:col-span-4"
                  />
                </form>
                        ...
                        >
                          ...
                          <div className="grid h-full min-w-0 gap-4 pr-8 lg:grid-cols-[200px_minmax(0,1fr)]">
                            <div className="min-w-0">
                              ...
                              <EditableText
                                value={item.imageUrl || ""}
                                placeholder="/images/items/nazwa.png"
                                onSave={(value) =>
                                ...
                                className="mt-2 block h-12 max-h-12 min-h-12 w-full overflow-y-auto break-all rounded-lg border border-neutral-700 bg-neutral-900 p-2 text-left text-xs text-neutral-400"
                                inputClassName="mt-2 h-12 max-h-12 min-h-12 w-full resize-none overflow-y-auto rounded-lg border border-red-700 bg-neutral-900 p-2 text-xs"
                              />
                            </div>
